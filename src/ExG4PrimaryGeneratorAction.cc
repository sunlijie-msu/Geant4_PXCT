	...
	fParticleGun(0)
{
	...
	Rmax = 1.5 * CLHEP::mm;  // 2D Uniform beam spot // in units of mm. G4ThreeVector(mm) Rmax = 1.5 mm for 152Eu Z2707; Rmax = 1.6 mm for 251Am Z7117 Modify
...
void ExG4PrimaryGeneratorAction::GeneratePrimaries(G4Event* anEvent)
{
	...
	// Update x0, y0, z0 with the tilted coordinates. 152Eu source is tilted. Comment out the following lines if 241Am source is used. Modify
//  	x0 = x0_tilted;
//  	y0 = y0_tilted;
//  	z0 = z0_tilted;
	...
	Eejectile = 0.030 * CLHEP::MeV; // modify energy of the ejectile 
