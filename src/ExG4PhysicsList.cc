...
//   fEmPhysicsList=new G4EmStandardPhysics();//tof=241 fs; final step dx=2.19 um
  ...
  fEmPhysicsList=new G4EmStandardPhysics();//PhysListEmStandard("local");//modify
...
void ExG4PhysicsList::ConstructProcess()
{
  ...
  //enable PIXIE and Augers
  G4LossTableManager::Instance()->AtomDeexcitation()->SetFluo(true);
  G4LossTableManager::Instance()->AtomDeexcitation()->SetPIXE(true);
  G4LossTableManager::Instance()->AtomDeexcitation()->SetAuger(true);
